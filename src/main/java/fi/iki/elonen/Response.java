...
public class Response {
  ...
  protected void send(OutputStream outputStream) {
    ...
    try {
      ...
      if (header != null) {
        header.keySet().stream().forEach((java.lang.String key) -> {
  ...
  private boolean headerAlreadySent(Map<String, String> header, String name) {
    return header.keySet().stream().map((headerName) -> headerName.equalsIgnoreCase(name)).reduce(false, (accumulator, _item) -> accumulator | _item);
  }
